  ...
  render() {
    ...
    return (
      <BootstrapTable
        ...
        <TableHeaderColumn width="180" dataField="name">
          Node Name
        </TableHeaderColumn>
        <TableHeaderColumn width="180" dataField="n_name">
          Neighbour Name
        </TableHeaderColumn>
        <TableHeaderColumn width="180" dataField="n_mac">
          Neighbour MAC
        </TableHeaderColumn>
        <TableHeaderColumn width="180" dataField="n_ipv6">
          Neighbour IPv6
        </TableHeaderColumn>
        <TableHeaderColumn width="80" dataField="metric">
          Metric
        </TableHeaderColumn>
