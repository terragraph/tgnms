...
export const DASHBOARD_TOOLTIP_LABELS = {
  NODE_A:
    "Choose a Node A to be used as a starting node in link graphs <br /> and as as node option in node graphs (doesn't apply to network graphs)",
  NODE_Z:
    "Choose a Node Z to be used as the ending node in link graphs <br /> and as another node option in node graphs (doesn't apply to network graphs)",
  APPLY_TO_ALL:
