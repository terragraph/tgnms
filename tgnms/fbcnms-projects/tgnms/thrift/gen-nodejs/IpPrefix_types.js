...
var BinaryAddress = module.exports.BinaryAddress = function(args) {
  this.addr = null;
  this.port = 0;
  this.ifName = '';
  if (args) {
...
var IpPrefix = module.exports.IpPrefix = function(args) {
...
var UnicastRoute = module.exports.UnicastRoute = function(args) {
  this.dest = null;
  this.nexthops = null;
  if (args) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i2 = 0; _i2 < _size0; ++_i2) {
          var elem3 = null;
          elem3 = new ttypes.BinaryAddress();
          elem3.read(input);
          this.nexthops.push(elem3);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
UnicastRoute.prototype.write = function(output) {
  ...
  if (this.nexthops !== null && this.nexthops !== undefined) {
    ...
    for (var iter4 in this.nexthops) {
      if (this.nexthops.hasOwnProperty(iter4)) {
        iter4 = this.nexthops[iter4];
        iter4.write(output);
      }
    }
    output.writeListEnd();
