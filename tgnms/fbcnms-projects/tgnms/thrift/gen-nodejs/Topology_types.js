...
var GolayIdx = module.exports.GolayIdx = function(args) {
...
var Site = module.exports.Site = function(args) {
  this.name = null;
  this.location = null;
  if (args) {
...
var Link = module.exports.Link = function(args) {
  this.name = null;
  ...
  this.a_node_mac = null;
  this.z_node_mac = null;
  this.is_backup_cn_link = null;
  if (args) {
    if (args.name !== undefined && args.name !== null) {
      this.name = args.name;
    }
    ...
    if (args.a_node_mac !== undefined && args.a_node_mac !== null) {
      this.a_node_mac = args.a_node_mac;
    }
    if (args.z_node_mac !== undefined && args.z_node_mac !== null) {
      this.z_node_mac = args.z_node_mac;
    }
    if (args.is_backup_cn_link !== undefined && args.is_backup_cn_link !== null) {
      this.is_backup_cn_link = args.is_backup_cn_link;
    }
  }
};
Link.prototype = {};
Link.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.a_node_mac = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.z_node_mac = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 11:
      if (ftype == Thrift.Type.BOOL) {
        this.is_backup_cn_link = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
...
Link.prototype.write = function(output) {
  ...
  if (this.a_node_mac !== null && this.a_node_mac !== undefined) {
    output.writeFieldBegin('a_node_mac', Thrift.Type.STRING, 9);
    output.writeString(this.a_node_mac);
    output.writeFieldEnd();
  }
  if (this.z_node_mac !== null && this.z_node_mac !== undefined) {
    output.writeFieldBegin('z_node_mac', Thrift.Type.STRING, 10);
    output.writeString(this.z_node_mac);
    output.writeFieldEnd();
  }
  if (this.is_backup_cn_link !== null && this.is_backup_cn_link !== undefined) {
    output.writeFieldBegin('is_backup_cn_link', Thrift.Type.BOOL, 11);
    output.writeBool(this.is_backup_cn_link);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
var Topology = module.exports.Topology = function(args) {
  this.name = null;
  this.nodes = null;
  this.links = null;
  this.sites = null;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i10 = 0; _i10 < _size8; ++_i10) {
          var elem11 = null;
          elem11 = new ttypes.Site();
          elem11.read(input);
          this.sites.push(elem11);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
Topology.prototype.write = function(output) {
  ...
  if (this.links !== null && this.links !== undefined) {
    ...
    for (var iter13 in this.links) {
      if (this.links.hasOwnProperty(iter13)) {
        iter13 = this.links[iter13];
        iter13.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.sites !== null && this.sites !== undefined) {
    ...
    for (var iter14 in this.sites) {
      if (this.sites.hasOwnProperty(iter14)) {
        iter14 = this.sites[iter14];
        iter14.write(output);
      }
    }
    output.writeListEnd();
