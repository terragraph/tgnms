...
const QueryRestrictor = module.exports.QueryRestrictor = function(args) {
...
const TypeaheadRequest = module.exports.TypeaheadRequest = function(args) {
...
TypeaheadRequest.prototype.write = function(output) {
  ...
  if (this.restrictors !== null && this.restrictors !== undefined) {
    ...
    for (let iter15 in this.restrictors) {
...
const KeyMetaData = module.exports.KeyMetaData = function(args) {
  this.keyId = null;
  this.keyName = null;
  this.shortName = null;
...
const TypeaheadResponse = module.exports.TypeaheadResponse = function(args) {
  this.results = null;
  if (args) {
...
const QueryRequest = module.exports.QueryRequest = function(args) {
  this.topologyName = null;
  this.keyNames = null;
  this.aggregation = 1;
  this.maxResults = 10;
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (let _i46 = 0; _i46 < _size41; ++_i46) {
          let elem47 = null;
...
QueryRequest.prototype.write = function(output) {
  ...
  if (this.keyNames !== null && this.keyNames !== undefined) {
    ...
    for (let iter48 in this.keyNames) {
  ...
  if (this.restrictors !== null && this.restrictors !== undefined) {
    output.writeFieldBegin('restrictors', Thrift.Type.LIST, 10);
    output.writeListBegin(Thrift.Type.STRUCT, this.restrictors.length);
    for (let iter49 in this.restrictors) {
...
const EventDescription = module.exports.EventDescription = function(args) {
  this.startTime = null;
  this.endTime = null;
...
const EventList = module.exports.EventList = function(args) {
  this.alive = null;
  this.events = null;
  if (args) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (let _i55 = 0; _i55 < _size50; ++_i55) {
          let elem56 = null;
...
const OutputFormatEvents = module.exports.OutputFormatEvents = function(args) {
  this.startTime = null;
  this.endTime = null;
  this.events = null;
  if (args) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (let _i63 = 0; _i63 < _size58; ++_i63) {
          let key64 = null;
          let val65 = null;
...
OutputFormatEvents.prototype.write = function(output) {
  ...
  if (this.events !== null && this.events !== undefined) {
    ...
    for (const kiter66 in this.events) {
      if (this.events.hasOwnProperty(kiter66)) {
        const viter67 = this.events[kiter66];
