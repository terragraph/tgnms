...
var streetSatellite = L.tileLayer(
  'https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?' +
    'access_token={accessToken}',
  {
    attribution:
...
var street = L.tileLayer(
    ...
    'access_token={accessToken}',
  {
    attribution:
      'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a>' +
      ' contributors',
    id: 'mapbox.streets', // or streets-basic
    maxNativeZoom: 18,
    maxZoom: 21,
    accessToken:
      'pk.eyJ1IjoiaGFwcHl6eXoiLCJhIjoiY2o3OXg4djF6MDh' +
...
var baseMaps = {
  "Light": background,
  "Street": street,
  "Street-satellite": streetSatellite
}
...
if (current_test === "Link healthiness") {
  ...
  initialLayers = [background, links, multihop];
