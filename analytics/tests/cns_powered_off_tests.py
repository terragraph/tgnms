...
class VisibilityUtilsTest(unittest.TestCase):
    def test_get_cn_info(self) -> None:
        nodes = [
            {"mac_addr": "00:11:22:33:44:55", "node_type": NodeType.CN},
            {"mac_addr": "11:11:22:33:44:55", "node_type": NodeType.CN},
            {"mac_addr": "22:11:22:33:44:55", "node_type": NodeType.DN},
            {"mac_addr": "33:11:22:33:44:55", "node_type": NodeType.DN},
        ]
        link1 = {
