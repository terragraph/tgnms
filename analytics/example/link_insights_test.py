...
class TestLinkInsights(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            # Just use the first topology in the api_service for testing
    ...
    def _extract_network_wide_stats(
        ...
        """ Extract stats from a json file dumped by a link pipeline.
        ...
        source_metric_name_filter: If not None, will extract keys_of_interest that is computed
        from the source_metric_name_filter. If None, will extract keys_of_interest that is
        computed using any metrics.
    ...
    def _plot_network_wide_cdf(
        ...
        """Visualize network wide CDF of the computed link stats.
           ...
           Each value denotes the computed stats of a link in the network.
    ...
    def test_get_valid_windows(self):
        ...
        # Case1.1: In this case, both sampled point with off_dp_idx0 and off_dp_idx1 is
        ...
        # In this case, the sampled point with off_dp_idx1 is considered invalid
        # and its left and right neighbors are removed.
        # The interval during the reset is removed.
        len_to_pad = 10
