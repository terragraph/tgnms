...
class VppCrashAnalyzer(CrashAnalyzer):
  ...
  def parse_crash_stack_trace(
    ...
    """
    if len(maybe_stack_trace) == 0 or re.match(VNET_LOG_STACK_TRACE_RE, maybe_stack_trace[0]) is None:
      return None
    ...
    return CrashDetails(crash_type, crash_time, node_id, application, function_name, stack_trace)
