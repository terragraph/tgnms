...
class CrashKey:
  ...
  def __init__(
      self, crash_type: Optional[str]=None, crash_time: Optional[str]=None,
      node_id: Optional[str]=None, application: Optional[str]=None
    ):
  ...
  def __eq__(self, other) -> bool:
    return (self.crash_type == other.crash_type and
           self.crash_time == other.crash_time and
