...
System.register(["app/core/utils/datemath", "lodash"], function (_export, _context) {
  "use strict";

  var dateMath, _, _createClass, TYPEAHEADTYPE, RESTRICTORTYPE, GenericDatasource;
  ...
  return {
    setters: [function (_appCoreUtilsDatemath) {
    ...
    execute: function () {
      ...
      TYPEAHEADTYPE = { "KEYNAME": 1, "NODENAME": 3, "TOPOLOGYNAME": 4 };
      RESTRICTORTYPE = { "NODE": 1, "LINK": 1 };
