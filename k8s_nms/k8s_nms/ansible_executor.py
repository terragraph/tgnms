...
class AnsibleExecutor:
    def __init__(self, run_tags, verbose, base_dir):
        display.verbosity = verbose
        self.loader = DataLoader()
        self.base_dir = base_dir
        self.inventory_file = os.path.join(self.base_dir, "inventory")
        self.group_vars_all = os.path.join(self.base_dir, "group_vars", "all")
        self.load_inventory()
        self.ssl_certs = None
    ...
    def get_defaults_file(self):
        breakpoint()
        return pkg_resources.resource_filename("k8s_nms", self.group_vars_all)

    def load_inventory(self):
        self.inventory = InventoryManager(
            loader=self.loader,
            sources=pkg_resources.resource_filename("k8s_nms", self.inventory_file),
        )
    ...
    def run(  # noqa: C901
        ...
        playbook_path = pkg_resources.resource_filename(
            "k8s_nms", os.path.join(self.base_dir, playbook)
        )
