...
GetCtrlConfigBaseReq.prototype.write = function(output) {
  ...
  if (this.swVersions !== null && this.swVersions !== undefined) {
    ...
    for (var iter119 in this.swVersions)
    {
      if (this.swVersions.hasOwnProperty(iter119))
      {
        iter119 = this.swVersions[iter119];
...
RebootReq.prototype.write = function(output) {
  ...
  if (this.nodes !== null && this.nodes !== undefined) {
    output.writeFieldBegin('nodes', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRING, this.nodes.length);
    for (var iter127 in this.nodes)
    {
      if (this.nodes.hasOwnProperty(iter127))
      {
        iter127 = this.nodes[iter127];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i133 = 0; _i133 < _size128; ++_i133)
        {
          ...
          val135 = new ttypes.StatusReport();
          val135.read(input);
          this.statusReports[key134] = val135;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
StatusDump.prototype.write = function(output) {
  ...
  if (this.statusReports !== null && this.statusReports !== undefined) {
    ...
    for (var kiter136 in this.statusReports)
    {
      if (this.statusReports.hasOwnProperty(kiter136))
      {
        var viter137 = this.statusReports[kiter136];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i143 = 0; _i143 < _size138; ++_i143)
        {
          ...
          val145 = input.readBool();
          this.linkAutoIgnite[key144] = val145;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
IgnitionParams.prototype.write = function(output) {
  ...
  if (this.linkAutoIgnite !== null && this.linkAutoIgnite !== undefined) {
    ...
    for (var kiter146 in this.linkAutoIgnite)
    {
      if (this.linkAutoIgnite.hasOwnProperty(kiter146))
      {
        var viter147 = this.linkAutoIgnite[kiter146];
        output.writeString(kiter146);
        output.writeBool(viter147);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i153 = 0; _i153 < _size148; ++_i153)
        {
          ...
          this.visitedNodeNames.push(elem154);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem161 = null;
          elem161 = new ttypes.IgnitionCandidate();
          elem161.read(input);
          this.igCandidates.push(elem161);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem168 = null;
          elem168 = new ttypes.IgnitionCandidate();
          elem168.read(input);
          this.lastIgCandidates.push(elem168);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
IgnitionState.prototype.write = function(output) {
  ...
  if (this.visitedNodeNames !== null && this.visitedNodeNames !== undefined) {
    ...
    for (var iter169 in this.visitedNodeNames)
    {
      if (this.visitedNodeNames.hasOwnProperty(iter169))
      {
        iter169 = this.visitedNodeNames[iter169];
  ...
  if (this.igCandidates !== null && this.igCandidates !== undefined) {
    ...
    for (var iter170 in this.igCandidates)
    {
      if (this.igCandidates.hasOwnProperty(iter170))
      {
        iter170 = this.igCandidates[iter170];
  ...
  if (this.lastIgCandidates !== null && this.lastIgCandidates !== undefined) {
    ...
    for (var iter171 in this.lastIgCandidates)
    {
      if (this.lastIgCandidates.hasOwnProperty(iter171))
      {
        iter171 = this.lastIgCandidates[iter171];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem178 = null;
          elem178 = new ttypes.SetNodeMac();
          elem178.read(input);
          this.setNodeMacList.push(elem178);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SetNodeMacList.prototype.write = function(output) {
  ...
  if (this.setNodeMacList !== null && this.setNodeMacList !== undefined) {
    ...
    for (var iter179 in this.setNodeMacList)
    {
      if (this.setNodeMacList.hasOwnProperty(iter179))
      {
        iter179 = this.setNodeMacList[iter179];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem186 = null;
          elem186 = new Topology_ttypes.Site();
          elem186.read(input);
          this.sites.push(elem186);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem193 = null;
          elem193 = new Topology_ttypes.Node();
          elem193.read(input);
          this.nodes.push(elem193);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem210 = null;
          elem210 = new ttypes.MicroRoute();
          elem210.read(input);
          this.routes.push(elem210);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ScanReq.prototype.write = function(output) {
  ...
  if (this.routes !== null && this.routes !== undefined) {
    ...
    for (var iter211 in this.routes)
    {
      if (this.routes.hasOwnProperty(iter211))
      {
        iter211 = this.routes[iter211];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem218 = null;
          elem218 = new ttypes.RouteInfo();
          elem218.read(input);
          this.routeInfoList.push(elem218);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ScanResp.prototype.write = function(output) {
  ...
  if (this.routeInfoList !== null && this.routeInfoList !== undefined) {
    ...
    for (var iter219 in this.routeInfoList)
    {
      if (this.routeInfoList.hasOwnProperty(iter219))
      {
        iter219 = this.routeInfoList[iter219];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem233 = null;
          elem233 = new ttypes.BeamIndices();
          elem233.read(input);
          this.beams.push(elem233);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
StartScan.prototype.write = function(output) {
  ...
  if (this.rxNodes !== null && this.rxNodes !== undefined) {
    ...
    for (var iter234 in this.rxNodes)
    {
      if (this.rxNodes.hasOwnProperty(iter234))
      {
        iter234 = this.rxNodes[iter234];
  ...
  if (this.beams !== null && this.beams !== undefined) {
    ...
    for (var iter235 in this.beams)
    {
      if (this.beams.hasOwnProperty(iter235))
      {
        iter235 = this.beams[iter235];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i241 = 0; _i241 < _size236; ++_i241)
        {
          ...
          val243 = new ttypes.ScanResp();
          val243.read(input);
          this.responses[key242] = val243;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
ScanData.prototype.write = function(output) {
  ...
  if (this.responses !== null && this.responses !== undefined) {
    ...
    for (var kiter244 in this.responses)
    {
      if (this.responses.hasOwnProperty(kiter244))
      {
        var viter245 = this.responses[kiter244];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i251 = 0; _i251 < _size246; ++_i251)
        {
          var key252 = null;
          var val253 = null;
          key252 = input.readI32();
          val253 = new ttypes.ScanData();
          val253.read(input);
          this.scans[key252] = val253;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
ScanStatus.prototype.write = function(output) {
  ...
  if (this.scans !== null && this.scans !== undefined) {
    ...
    for (var kiter254 in this.scans)
    {
      if (this.scans.hasOwnProperty(kiter254))
      {
        var viter255 = this.scans[kiter254];
        output.writeI32(kiter254);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i261 = 0; _i261 < _size256; ++_i261)
        {
          ...
          {
            var elem270 = null;
            elem270 = new ttypes.Slot();
            elem270.read(input);
            val263.push(elem270);
          }
          input.readListEnd();
          this.mapping[key262] = val263;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
SlotMapConfig.prototype.write = function(output) {
  ...
  if (this.mapping !== null && this.mapping !== undefined) {
    ...
    for (var kiter271 in this.mapping)
    {
      if (this.mapping.hasOwnProperty(kiter271))
      {
        var viter272 = this.mapping[kiter271];
        output.writeI32(kiter271);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem280 = null;
          elem280 = new ttypes.BgpNeighbor();
          elem280.read(input);
          this.neighbors.push(elem280);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BgpNeighbors.prototype.write = function(output) {
  ...
  if (this.neighbors !== null && this.neighbors !== undefined) {
    ...
    for (var iter281 in this.neighbors)
    {
      if (this.neighbors.hasOwnProperty(iter281))
      {
        iter281 = this.neighbors[iter281];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem288 = null;
          elem288 = new ttypes.BgpNeighbor();
          elem288.read(input);
          this.neighbors.push(elem288);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BgpConfig.prototype.write = function(output) {
  ...
  if (this.neighbors !== null && this.neighbors !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.neighbors.length);
    for (var iter289 in this.neighbors)
    {
      if (this.neighbors.hasOwnProperty(iter289))
      {
        iter289 = this.neighbors[iter289];
...
NetworkInfo.prototype.write = function(output) {
  ...
  if (this.aggrCtrlUrl !== null && this.aggrCtrlUrl !== undefined) {
    ...
    for (var iter297 in this.aggrCtrlUrl)
    {
      if (this.aggrCtrlUrl.hasOwnProperty(iter297))
      {
        iter297 = this.aggrCtrlUrl[iter297];
