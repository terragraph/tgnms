...
var self = {
  getStatusDump: function (index, configs, statusDumps) {
    ...
    dealer.on('message', function (receiver, senderApp, msg) {
      ...
      var statusDump = new aggregatorTTypes.AggrStatusDump_Deprecated();
    ...
    var statusDumpMessage = new aggregatorTTypes.AggrMessage();
    statusDumpMessage.mType =
      aggregatorTTypes.AggrMessageType.GET_STATUS_DUMP_DEPRECATED;
