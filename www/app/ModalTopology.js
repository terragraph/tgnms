              ...
              <tr>
                ...
                <td width={100}>
                  <button
                    ...
                    onClick={this.onAddSite.bind(this)}
                  >
                    Add Planned
                  </button>
                </td>
                <td width={100}>
                  <button
                    ...
                    onClick={() =>
                      swal(
                        "Select a Site on the map and delete it from the details menu!"
                      )
                    }
                  >
                    Remove
              ...
              <tr>
                ...
                <td width={100}>
                  <button
                    style={{ float: "right" }}
                    className="graph-button"
                    onClick={() => this.setState({ addNodeModalOpen: true })}
                  >
                    Add
                  </button>
                </td>
                <td width={100}>
                  <button
                    ...
                    onClick={() =>
                      swal(
                        "Select a Node on the map and delete it from the details menu!"
                      )
                    }
                  >
                    Remove
              ...
              <tr>
                ...
                <td width={100}>
                  <button
                    style={{ float: "right" }}
                    className="graph-button"
                    onClick={() => this.setState({ addLinkModalOpen: true })}
                  >
                    Add
                  </button>
                </td>
                <td width={100}>
                  <button
                    ...
                    onClick={() =>
                      swal(
                        "Select a Link on the map and delete it from the details menu!"
                      )
                    }
                  >
                    Remove
              ...
              <tr>
                ...
                <td width={100}>
                  <button
                    ...
                    className="graph-button"
                    onClick={() =>
                      this.setState({ compareTopologyLiveOpen: true })
                    }
                  >
                    Compare Live
                  </button>
              ...
              <tr>
                ...
                <td width={100}>
                  <button
                    style={{ float: "right" }}
                    className="graph-button"
                    onClick={() => this.setState({ uploadCSVModelOpen: true })}
                  >
                    Upload
                  </button>
                </td>
