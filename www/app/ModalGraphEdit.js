...
export default class ModalGraphEdit extends React.Component {
  ...
  render() {
    ...
    let keyOptions = this.getKeyOptions(
      ...
      >
        <div width="800" height="800">
          ...
          <input
            ...
            onChange={event => this.setState({ graphName: event.target.value })}
          />
          <br />
          <br />
          <Typeahead
          ...
          <button
            ...
            onClick={this.modalClose.bind(this, true)}
          >
            Set
          </button>
          <button
            ...
            className="graph-button"
            onClick={this.modalClose.bind(this, false)}
          >
            Cancel
          </button>
        </div>
