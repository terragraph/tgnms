  ...
  render() {
    ...
    return (
      <div className='rc-upgrade-left-pane'>
        <label style={{fontSize:'20px', marginTop:'10px'}}>Upgrade Operations</label>
        <button className='upgrade-btn' onClick={this.launchUpgradeServer}>Manage Upgrade Images</button>
        <button className='upgrade-btn' onClick={this.prepareUpgradeWithAlert}>Prepare</button>
        <button className='upgrade-btn' onClick={this.commitUpgradeWithAlert}>Commit</button>
